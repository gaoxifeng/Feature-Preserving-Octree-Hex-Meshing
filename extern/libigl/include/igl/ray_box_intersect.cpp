...
template bool igl::ray_box_intersect<class Eigen::Matrix<double, 1, 3, 1, 1, 3>, class Eigen::Matrix<double, 1, 3, 1, 1, 3>, double>(class Eigen::PlainObjectBase<class Eigen::Matrix<double, 1, 3, 1, 1, 3> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, 1, 3, 1, 1, 3> > const &, class Eigen::AlignedBox<double, 3> const &, double const &, double const &, double &, double &);
#endif