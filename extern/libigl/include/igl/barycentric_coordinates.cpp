...
#endif
#ifdef WIN32
template void igl::barycentric_coordinates<class Eigen::Matrix<double, 1, 2, 1, 1, 2>, class Eigen::Block<class Eigen::Matrix<double, -1, -1, 0, -1, -1>, 1, -1, 0>, class Eigen::Block<class Eigen::Matrix<double, -1, -1, 0, -1, -1>, 1, -1, 0>, class Eigen::Block<class Eigen::Matrix<double, -1, -1, 0, -1, -1>, 1, -1, 0>, class Eigen::Matrix<double, 1, 3, 1, 1, 3> >(class Eigen::MatrixBase<class Eigen::Matrix<double, 1, 2, 1, 1, 2> > const &, class Eigen::MatrixBase<class Eigen::Block<class Eigen::Matrix<double, -1, -1, 0, -1, -1>, 1, -1, 0> > const &, class Eigen::MatrixBase<class Eigen::Block<class Eigen::Matrix<double, -1, -1, 0, -1, -1>, 1, -1, 0> > const &, class Eigen::MatrixBase<class Eigen::Block<class Eigen::Matrix<double, -1, -1, 0, -1, -1>, 1, -1, 0> > const &, class Eigen::PlainObjectBase<class Eigen::Matrix<double, 1, 3, 1, 1, 3> > &);
#endif
