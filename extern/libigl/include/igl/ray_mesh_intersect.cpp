...
template bool igl::ray_mesh_intersect<class Eigen::Matrix<float, 3, 1, 0, 3, 1>, class Eigen::Matrix<float, 3, 1, 0, 3, 1>, class Eigen::Matrix<double, -1, -1, 0, -1, -1>, class Eigen::Matrix<int, -1, -1, 0, -1, -1> >(class Eigen::MatrixBase<class Eigen::Matrix<float, 3, 1, 0, 3, 1> > const &, class Eigen::MatrixBase<class Eigen::Matrix<float, 3, 1, 0, 3, 1> > const &, class Eigen::MatrixBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > const &, class Eigen::MatrixBase<class Eigen::Matrix<int, -1, -1, 0, -1, -1> > const &, struct igl::Hit &);
template bool igl::ray_mesh_intersect<class Eigen::Matrix<double, 1, 3, 1, 1, 3>, class Eigen::Matrix<double, 1, 3, 1, 1, 3>, class Eigen::Matrix<double, -1, -1, 0, -1, -1>, class Eigen::Block<class Eigen::Matrix<int, -1, -1, 0, -1, -1> const, 1, -1, 0> >(class Eigen::MatrixBase<class Eigen::Matrix<double, 1, 3, 1, 1, 3> > const &, class Eigen::MatrixBase<class Eigen::Matrix<double, 1, 3, 1, 1, 3> > const &, class Eigen::MatrixBase<class Eigen::Matrix<double, -1, -1, 0, -1, -1> > const &, class Eigen::MatrixBase<class Eigen::Block<class Eigen::Matrix<int, -1, -1, 0, -1, -1> const, 1, -1, 0> > const &, struct igl::Hit &);
#endif
